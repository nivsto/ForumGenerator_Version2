...
namespace ConsoleApplication1
{
    public class XmlHandler
    {
         ...
         */
        public LinkedList<String> getXmlParse(string xml_string)
        {
        ...
        /*
         * Returns value of a given argument if exist, null otherwise.
         */
        public string getValue(string xmlString, string a_arg)
        {
            string res = null;

            XmlDocument xreader = new XmlDocument();
            xreader.LoadXml(xmlString);
            ...
            param_list = xreader.GetElementsByTagName("params");
            XmlNodeList args_list = param_list.Item(0).ChildNodes;
            foreach (XmlNode currArg in args_list)
            {
                res = currArg.Value;
                if (currArg.Name.Equals(a_arg))
                {   // found
                    res = currArg.InnerText;
                    break;
                }
            }
